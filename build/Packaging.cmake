...
SET(CPACK_PACKAGE_INSTALL_DIRECTORY "MuseScore ODLA")
...
IF(MINGW OR MSVC)
    ...
    SET(MSCORE_EXECUTABLE_NAME "${MUSESCORE_NAME} ODLA")
    ...
    SET(CPACK_PACKAGE_EXECUTABLES   "${MSCORE_EXECUTABLE_NAME} ODLA") # exe name, label
    SET(CPACK_CREATE_DESKTOP_LINKS "${MSCORE_EXECUTABLE_NAME} ODLA") #exe name, label

    SET(CPACK_PACKAGE_FILE_NAME     "${MUSESCORE_NAME} ODLA")

ELSE(MINGW OR MSVC)
    SET(CPACK_PACKAGE_ICON "${PROJECT_SOURCE_DIR}/mscore/data/mscore.bmp")
    SET(CPACK_STRIP_FILES "${MSCORE_OUTPUT_NAME}")
    SET(CPACK_SOURCE_STRIP_FILES "")
    SET(CPACK_PACKAGE_EXECUTABLES   "${MUSESCORE_NAME} ODLA")
    SET(CPACK_SOURCE_PACKAGE_FILE_NAME "${MUSESCORE_NAME} ODLA")
    SET(CPACK_PACKAGE_FILE_NAME     "${CPACK_SOURCE_PACKAGE_FILE_NAME}-${MUSESCORE_VERSION_FULL}${git_date_string}")
ENDIF(MINGW OR MSVC)

set(CPACK_DEBIAN_PACKAGE_NAME         "${MUSESCORE_NAME} ODLA")
